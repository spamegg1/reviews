...
This cheat sheet originated from the forums, credits to Laurent Poulain. We copied it and changed or added a few things. 
...
- Click the "Edit" button on this file on GitHub:https://github.com/lampepfl/progfun-wiki/blob/gh-pages/CheatSheet.md You can submit a pull request directly from there without checking out the git repository to your local machine.
- Fork the repository https://github.com/lampepfl/progfun-wiki and check it out locally. To preview your changes, you need [jekyll](https://jekyllrb.com/). Navigate to your checkout and invoke jekyll --auto --server, then open the page http://localhost:4000/CheatSheet.html.
