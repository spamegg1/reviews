...
val test1g = all_except_option ("string", ["a", "string", "b", "c", "string", "d", "e", "f"]) = SOME(["a", "b", "c", "d", "e", "f"])
...
val test2d = get_substitutions1 ([["Fred", "Fredrick"],["Elizabeth", "Betty"],["Freddie", "Fred", "F"]], "Fred") = ["Fredrick", "Freddie", "F"]
val test2e = get_substitutions1 ([["Fred", "Fredrick"],["Jeff", "Jeffrey"],["Geoff","Jeff", "Jeffrey"]], "Jeff") = ["Jeffrey", "Geoff", "Jeffrey"]
...
val test3d = get_substitutions2 ([["Fred", "Fredrick"],["Elizabeth", "Betty"],["Freddie", "Fred", "F"]], "Fred") = ["Fredrick", "Freddie", "F"]
val test3e = get_substitutions2 ([["Fred", "Fredrick"],["Jeff", "Jeffrey"],["Geoff","Jeff", "Jeffrey"]], "Jeff") = ["Jeffrey", "Geoff", "Jeffrey"]
...
val test4b = similar_names ([["Fred", "Fredrick"],["Jeff", "Jeffrey"],["Geoff","Jeff", "Jeffrey"]], {first="Jeff", middle="Z", last="Jeffries"}) =
	    [{first="Jeff", middle="Z", last="Jeffries"}, {first="Jeffrey", middle="Z", last="Jeffries"},{first="Geoff", middle="Z", last="Jeffries"},{first="Jeffrey", middle="Z", last="Jeffries"}]
...
val test7d = remove_card ([(Spades, Queen), (Hearts, Ace), (Diamonds, Jack)], (Hearts, Ace), IllegalMove) = [(Spades, Queen), (Diamonds, Jack)]
val test7e = remove_card ([(Spades, Num 1), (Hearts, Ace), (Diamonds, Num 5), (Hearts, Ace)], (Hearts, Ace), IllegalMove) = [(Spades, Num 1), (Diamonds, Num 5), (Hearts, Ace)]
...
val test8f = all_same_color [(Clubs, Ace), (Spades, Ace), (Clubs, Jack), (Hearts, Ace)] = false
...
val test11d = officiate ([(Hearts, Num 2),(Clubs, Num 4)],[Draw,Draw,Discard(Clubs,Num 4)], 15) = 6
