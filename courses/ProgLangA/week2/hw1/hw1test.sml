...
val test3e = number_in_months ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3]) = 2
...
val test4e = dates_in_month ([(2012,3,28), (2013,12,1), (2013,3,29)], 3) = [(2012,3,28),(2013,3,29)]
val test4f = dates_in_month ([(2012,3,28), (2013,12,1), (2013,3,29), (2011,1,1), (2014,12,1), (2013,3,2), (2015,12,1)], 3) = [(2012,3,28),(2013,3,29),(2013,3,2)]

val test5a = dates_in_months([], []) = []
val test5b = dates_in_months([], [2]) = []
val test5c = dates_in_months([(2012, 3, 28), (2013, 12, 1)], []) = []
val test5d = dates_in_months ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2]) = [(2012,2,28)]
val test5e = dates_in_months ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3]) = [(2012,2,28),(2011,3,31)]
val test5f = dates_in_months ([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,4]) = [(2012,2,28),(2011,3,31),(2011,4,28)]
...
val test11c = oldest([(2012,2,28),(2011,3,31),(2011,4,28)]) = SOME (2011,3,31)
val test11d = oldest([(2011,2,28),(2011,2,28),(2011,4,28)]) = SOME (2011,2,28)
val test11e = oldest([(2011,3,31),(2011,3,31),(2011,3,31)]) = SOME (2011,3,31)
