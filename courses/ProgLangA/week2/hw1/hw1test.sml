...
val test3e = number_in_months(
    [(2012, 2, 28), (2013, 12, 1), (2011, 3, 31), (2011, 4, 28)], [2, 3]
) = 2
val test3f = number_in_months(
    [(2012, 2, 28), (2013, 12, 1), (2011, 3, 31), (2011, 4, 28)], [2, 3, 4]
) = 3

val test4a = null(dates_in_month([], 1))
val test4b = null(dates_in_month([(2012, 2, 28), (2013, 12, 1)], 1))
val test4c = dates_in_month([(2012, 2, 28), (2013, 12, 1)], 2)
    = [(2012, 2, 28)]
val test4d = dates_in_month([(2012, 2, 28), (2013, 12, 1)], 12)
    = [(2013, 12, 1)]
...
val test5a = null(dates_in_months([], []))
val test5b = null(dates_in_months([], [2]))
val test5c = null(dates_in_months([(2012, 3, 28), (2013, 12, 1)], []))
val test5d = dates_in_months(
    [(2012, 2, 28), (2013, 12, 1), (2011, 3, 31), (2011, 4, 28)], [2]
) = [(2012, 2, 28)]
val test5e = dates_in_months(
    [(2012, 2, 28), (2013, 12, 1), (2011, 3, 31), (2011, 4, 28)], [2,3]
) = [(2012, 2, 28), (2011, 3, 31)]
val test5f = dates_in_months([
    (2012, 2, 28), (2013, 12, 1), (2011, 3, 31), (2011, 4, 28)], [2, 3, 4]
...
val test10a = null(month_range(2, 1))
