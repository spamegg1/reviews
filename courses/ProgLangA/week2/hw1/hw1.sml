...
(*  returns how many dates in date list are in any of the months in the list of months  *)
...
(*  int, int list -> int  *)
(*  returns first n such that sum of first n elts of list < sum, but of first n+1 elts >= sum  *)
(*  Assumes sum > 0, list has positive numbers, and entire list sums to more than sum  *)
