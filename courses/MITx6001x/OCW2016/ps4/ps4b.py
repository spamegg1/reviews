...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for index in range(26):
            ...
            upper = string.ascii_uppercase[index]
            shift_dict[lower] = string.ascii_lowercase[(index + shift) % 26]
            shift_dict[upper] = string.ascii_uppercase[(index + shift) % 26]
