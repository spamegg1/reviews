...
class BloxorzSuite extends munit.FunSuite:
  trait SolutionChecker extends GameDef with Solver with StringParserTerrain:
    /** This method applies a list of moves `ls` to the block at position `startPos`. This
      * can be used to verify if a certain list of moves is a valid solution, i.e. leads
      * to the goal.
      */
    import Move.*
    def solve(ls: List[Move]): Block =
      ls.foldLeft(startBlock): (block, move) =>
