...
<html lang="en">
    ...
    <script>
        fetch("https://s3.amazonaws.com/cdn.cs50.net/2022/spring/classes/3/candidate_array.c?AWSAccessKeyId=AKIAJWDAOEC2ETXV2L6A\u0026Signature=NZLpNoJIcj9hvYKs9q8JnDPR3uY%3D\u0026Expires=1649575971")
        .then((response) => {
