...
<html lang="en">
    ...
    <script>
        fetch("https://s3.amazonaws.com/cdn.cs50.net/2022/spring/classes/3/candidate.c?AWSAccessKeyId=AKIAJWDAOEC2ETXV2L6A\u0026Signature=SSJ7sIH9lPWzXoc7Ymt96XgDlPY%3D\u0026Expires=1649575950")
        .then((response) => {
