...
<html lang="en">
    ...
    <script>
        fetch("https://s3.amazonaws.com/cdn.cs50.net/2022/spring/classes/3/get_candidate.c?AWSAccessKeyId=AKIAJWDAOEC2ETXV2L6A\u0026Signature=p%2BRjY%2Frf3G9cCSTOD4Z7cu9ezjc%3D\u0026Expires=1649575964")
        .then((response) => {
