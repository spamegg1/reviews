...
<html lang="en">
    ...
    <script>
        fetch("https://s3.amazonaws.com/cdn.cs50.net/2022/spring/classes/4/pdf_solved.c?AWSAccessKeyId=AKIAJWDAOEC2ETXV2L6A\u0026Signature=0V7QLNKrkNwuWlnxENd680Hwyqk%3D\u0026Expires=1649599313")
        .then((response) => {
