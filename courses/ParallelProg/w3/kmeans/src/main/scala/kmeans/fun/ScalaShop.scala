...
object ScalaShop:
  class ScalaShopFrame extends JFrame("ScalaShop\u2122"):
    ...
    val colorControls = JPanel() // Color count selection
    ...
    val initSelectionControls = JPanel() // Initial selection
    ...
    val convergenceControls = JPanel() // Initial means selection
    ...
    val actionControls = JPanel() // Action Buttons
    ...
    saveMenuItem.addActionListener(
      new ActionListener:
        def actionPerformed(e: ActionEvent): Unit =
          ...
          then canvas.saveFile(fc.getSelectedFile.getPath)
    )
    ...
    aboutMenuItem.addActionListener(
      new ActionListener:
        def actionPerformed(e: ActionEvent): Unit = JOptionPane.showMessageDialog(
          null,
    ...
    def getColorCount: Int = colorCountSpinner.getValue.asInstanceOf[Int]
