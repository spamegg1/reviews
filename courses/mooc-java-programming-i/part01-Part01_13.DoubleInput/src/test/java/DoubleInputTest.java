...
public class DoubleInputTest {
    ...
    @Test
    public void correctOutputWhenNumber_14() {
        correctOutput("3.14");
    }

    @Test
    public void correctOutputWhenNumber2_92() {
        correctOutput("2.92");
    }

    @Test
    public void inputConvertedToDouble() {
        try {
    ...
    public void correctOrder() {
        List<String> code = code("DoubleInput.java");
        int count = countOccurrences(code, "System.out.println.*Double.*System.out.println");
        int count2 = countOccurrences(code, "System.out.println.*nextDouble.*System.out.println");
