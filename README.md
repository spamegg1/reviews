...
Also check out my [Fullstack Open review](#fsopen) below. Modern JavaScript is full of functional programming all over.
...
Part 5 is about frontend and End-to-End testing. In the frontend we learn about child components and lifting up state that is shared between parent and child components. For testing [Cypress](https://www.cypress.io/) is used (instead of something like the very popular but complicated [Selenium](https://www.selenium.dev/)).
