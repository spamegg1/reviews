...
[Testing JavaScript](https://testingjavascript.com/) describes 4 fundamental steps to flawless testing: 1. static (type checking), 2. unit, 3. integration, and 4. end-to-end. In Part 5 we skip the first: we do not learn about TypeScript yet; and the third. However the course is fully aware of this: TypeScript is covered in Part 9, and the lectures mention that we **should** do integration testing of multiple components working together, but that it would be way too long, difficult and complicated and it's beyond the scope of the course.
